        ...
        (0, _createClass3['default'])(CalenderWrapper, [{
            ...
            value: function render() {
                ...
                var clearIcon = !props.disabled && props.allowClear && value ? props.clearIcon ? React.createElement(
                    ...
                    props.clearIcon
                ) : React.createElement(_icon2['default'], { type: 'cross-circle', className: prefixCls + '-picker-clear', onClick: this.clearSelection }) : null;
                var inputValue = '';
                if (value) {
                ...
                var input = function input() {
                    return React.createElement(
                        'div',
                        null,
                        React.createElement('input', { ref: _this2.saveInput, disabled: props.disabled, readOnly: true, value: inputValue, placeholder: placeholder, className: props.pickerInputClass, tabIndex: props.tabIndex }),
                        clearIcon,
                        props.pickerIcon || React.createElement('span', { className: prefixCls + '-picker-icon' })
                    );
                };
                return React.createElement(
                    'span',
