            ...
            value: function render() {
                ...
                var input = function input() {
                    return React.createElement(
                        'div',
                        null,
                        React.createElement('input', { ref: _this2.saveInput, disabled: props.disabled, readOnly: true, value: inputValue, placeholder: placeholder, className: props.pickerInputClass }),
                        clearIcon,
