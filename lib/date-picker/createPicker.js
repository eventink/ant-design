    ...
    var CalenderWrapper = function (_React$Component) {
                ...
                if (props.multiple) {
                    ...
                    if (value && value.length) {
                        formattedValue = value.map(function (singleValue) {
                            return singleValue.format(props.format);
                        }).join(', ');
                    }
        ...
        (0, _createClass3['default'])(CalenderWrapper, [{
            ...
            value: function render() {
                ...
                var calendar = React.createElement(TheCalendar, (0, _extends3['default'])({}, calendarProps, { disabledDate: props.disabledDate, disabledTime: disabledTime, locale: locale.lang, timePicker: props.timePicker, defaultValue: props.defaultPickerValue || (multiple ? [(0, _interopDefault2['default'])(moment)()] : (0, _interopDefault2['default'])(moment)()), dateInputPlaceholder: placeholder, prefixCls: prefixCls, className: calendarClassName, onOk: props.onOk, dateRender: props.dateRender, format: props.format, showToday: props.showToday, monthCellContentRender: props.monthCellContentRender, renderFooter: this.renderFooter, onPanelChange: props.onPanelChange, onChange: this.handleCalendarChange, multiple: multiple, selectWeekDays: selectWeekDays, selectMonths: selectMonths, value: showDate }));
                var clearIcon = !props.disabled && props.allowClear && value ? props.clearIcon ? React.createElement(
                    'span',
                    { onClick: this.clearSelection },
                    props.clearIcon
                ) : React.createElement(_icon2['default'], { type: 'close-circle', className: prefixCls + '-picker-clear', onClick: this.clearSelection, theme: 'filled' }) : null;
                ...
                var input = function input(_ref) {
                    ...
                    if (inputValue) {
                        if (props.formatInput) {
                            ...
                            if (multiple) {
                                formattedInputValue = inputValue.map(function (singleValue) {
                                    return singleValue.format(props.format);
                                }).join(', ');
                            } else {
                    ...
                    return React.createElement(
                        'div',
                        null,
                        React.createElement('input', (0, _extends3['default'])({ ref: _this2.saveInput, disabled: props.disabled, readOnly: true, value: formattedInputValue, placeholder: placeholder, className: props.pickerInputClass, tabIndex: props.tabIndex }, dataOrAriaProps)),
                        clearIcon,
